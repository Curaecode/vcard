...
<div class="card xcard front">
	...
	<div class="card-body">
		...
		<div class="user-data">
			<div class="row" style="width:100%;">
				...
				<?php } ?>
				<?php if(($showname->value==1) || ($showdependent->value==1 && isset($dependent) && !empty($dependent))){  $col='4'; }else{$col='12'; } ?>
				<div class="col-sm-<?php echo $col;?>"  <?php if(($showname->value==1) || ($showdependent->value==1 && isset($dependent) && !empty($dependent))){ ?>style="float:left;width: 33%;" <?php } ?>>
	...
	<div class="card-highlight">
		<p style="font-size:9px; color: #fff; margin: 0px;  padding: 0px;">This card is the property of CuraeChoice, LLC. If found please return to: 3179 Green Valley Road, Suite 634, Vestavia, AL 35243-5239.</p>
	</div>
</div> 
</body>
</html>