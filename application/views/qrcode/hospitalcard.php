			...
			<div class="row d-flex align-items-center justify-content-center">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-wrap py-3">
						...
						<form action="" id="hospitalcardform" class="login-form">
							...
							<div class="form-group">
								<div class="row">
									...
									<button type="button" onclick="gethospitalcode();" class="btn btn-sm form-control btn-primary rounded submit px-3 ">Send Code</button>
									</div>  
								</div> 
							</div>  
