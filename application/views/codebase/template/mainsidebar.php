                    ...
                    <ul class="navbar-nav">  
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark loadview" href="#" data-bs-toggle="dropdown"
                                ...
                                <img src="<?php echo res_url();?>admin/<?php echo $imageconfig->value;?>" alt="user" width="50" class="profile-pic rounded-circle" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                                <div class="d-flex no-block align-items-center p-3 bg-info text-white mb-2">
                                    <div class=""><img src="<?php echo res_url();?>admin/<?php echo $imageconfig->value;?>" alt="user" class="rounded-circle" width="50"></div>
                                    <div class="ms-2">
