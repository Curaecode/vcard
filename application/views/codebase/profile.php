            <!-- Main Container -->
           	<?php echo @$msg; ?>
                ...
                <div class="bg-image bg-image-bottom" style="background-image: url('<?php echo res_url();?>linkstatus/assets/media/photos/photo13@2x.jpg');">
                        ...
                        <div class="content content-full text-center">
						   ...
						   <div class="mb-15">
								...
								<input type="file" id="exampleInputFile" name="fileToUpload" onchange="document.getElementById('blah1').src = window.URL.createObjectURL(this.files[0])" style="display: none;" > 
									 ...
									 <img src="<?php echo res_url()."admin/";echo isset($edit["image"])?$edit["image"]:"default.jpg"; ?>" id="blah1" class="profile-img" style="cursor: pointer;object-fit: contain;height: 150px;border-radius: 50%;box-shadow: 0 0 0 5px rgba(255,255,255,.4);">
							...
							<div class="container">
								<div class="row">
										...
										<div class="block">
											...
											<div class="block-content">
												...
												<div class="form-group row">
													...
													<div class="col-12">
												 		<input type='text' value='<?php echo isset($edit["email"]) ? $edit["email"]:""; ?>' class='form-control' name='email' readonly>
													</div>
												</div>
												<div class="form-group row">
									...
									<div class="col-lg-6">
										<div class="block">
											<div class="block-header block-header-default">
												<h3 class="block-title">Username</h3>
											</div>
											<div class="block-content">
													<div class="form-group row">
