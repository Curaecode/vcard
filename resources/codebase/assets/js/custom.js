...
function deletecontacts(){
	 if($(".checkbox:checked").length > 0) {
		...
		$.ajax({
            type:'POST',
            url:base_url+'admin/dashboard/deletecontacts/',
            data:{id:selectedids},
            type:"post",
			dataType:"json",
            success:function(data){
		 ...
		 Swal.fire("Error!",'Please select the contact to delete.', "error");   
	 }
	return false;
}
	...
	if(datatable){ 
		...
		table = $('.datatable').DataTable({ 
			"lengthMenu": [[100, 250, 500,1000,-1], [100, 250, 500,1000,"All"]],
			 /* dom: 'Blfrtip', */
			 "dom": '<"row"<"col-md-6"l><"col-md-6 text-end"B>><"row"<"col-md-12"<"'+responsive+'"rt>>><"row"<"col-md-6"i<"toolbar">><"col-md-6 text-end"p>>',
			buttons: [
				'copy', 'csv', 'excel', 'pdf' 
			],
			/* "scrollY":        "300px",
